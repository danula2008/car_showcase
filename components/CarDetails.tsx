      ...
      <Transition appear show={isOpen} as={Fragment}>
        <Dialog as="div" className="relative z-10" onClose={closeModel}>
          ...
          <div className="fixed inset-0 overflow-y-auto">
            <div className="flex min-h-full items-center justify-center p-4 text-cener">
              <TransitionChild
                as={Fragment}
                enter="ease-out duration-300"
              ...
              >
                <DialogPanel className="relative w-full max-w-lg max-h-[90vh] overflow-y-auto transform rounded-2xl bg-white p-6 text-left shadow-xl transition-all flex flex-col gap-5">
                  <button
                    className="border border-black border-opacity-5 absolute top-2 right-2 z-10 w-fit p-2 bg-primary-blue-100 rounded-full hover:scale-110 duration-300"
                    type="button"
                    onClick={closeModel}
                  >
                    <Image
